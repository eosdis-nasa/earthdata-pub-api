...
INSERT INTO question VALUES ('4ecc885f-daf8-4bc6-a8cd-d30c2a54d739', 'assignment_form_open_data_policy', 1, 'Open Data Requirements', ' Can your data be publicly released in compliance with NASA’s Open Data Requirements?', 'For a description of the open data Requirements, please refer to the <a href="https://www.earthdata.nasa.gov/engage/open-data-services-software-policies/data-information-guidance" target=_blank>NASA Earthdata Data and Information Guidance <i class="fas fa-external-link-alt"></i></a>.');

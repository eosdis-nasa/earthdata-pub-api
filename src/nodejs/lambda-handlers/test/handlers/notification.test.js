...
describe('notification', () => {
    ...
    it('should send a direct message', async () => {
        ...
        msg.sendEvent.mockImplementation(async(params) => {
    ...
    it('should get a list of conversations', async () => {
        ...
        db.note.getPrivilegedConversationList.mockImplementationOnce(async(params) => {
            expect(params).toEqual({
                user_id: 'test user'
            })
    ...
    it('should load a conversation', async () => {
        ...
        db.user.findById.mockResolvedValueOnce({ user_privileges: [], user_groups: [] });
        db.note.readConversation.mockImplementationOnce(async(params) => {
            expect(params).toEqual({
                conversation_id: 'test conversation',
                step_name: 'test step'
            })

const getReviewerAddedTemplate = (params, envUrl) => {
  console.log('eventMessage', params);

  const text = `Hello ${params.user.name},\n\nYou have been added as a reviewer to the ${params.eventMessage.stepName} request.\nYour review can be added at ${envUrl}/dashboard/dashboard/forms/id/${params.eventMessage.stepName}?requestId=${params.eventMessage.submissionId}.`;
  const html = `
    <html>
           ...
           <table border="0" cellpadding="10" cellspacing="0" style="width:100%">
             ...
             <tr>
               <td colspan="2" style="padding:20px;">
                 ...
                 <p>Your review can be added at <a aria-label="Visit Earthdata Pub Dashboard" href="${envUrl}/dashboard/dashboard/forms/id/${params.eventMessage.stepName}?requestId=${params.eventMessage.submissionId}">${envUrl}/dashboard/dashboard/forms/id/${params.stepName}?requestId=${params.submissionId}</a>.</p><br>

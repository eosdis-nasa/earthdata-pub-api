module.exports.model = (path) => ({
  ...
  properties: {
    ...
    PaleoTemporalCoverages: {
      ...
      type: 'array',
      items: {
        $ref: `#${path}PaleoTemporalCoverageType`
      },
      minItems: 0
    },
    TemporalKeywords: {
  ...
  definitions: {
    ...
    UseConstraintsType: {
      ...
      properties: {
        Description: {
          $ref: `#${path}UseConstraintsDescriptionType`
        },
        LicenseUrl: {
    ...
    PaleoTemporalCoverageType: {
      ...
      properties: {
        ChronostratigraphicUnits: {
          ...
          type: 'array',
          items: {
            $ref: `#${path}ChronostratigraphicUnitType`
          },
          minItems: 0
        },
        StartDate: {
    ...
    SpatialExtentType: {
      ...
      properties: {
        ...
        HorizontalSpatialDomain: {
          $ref: `#${path}HorizontalSpatialDomainType`
        },
        VerticalSpatialDomains: {
          type: 'array',
          items: {
            $ref: `#${path}VerticalSpatialDomainType`
          }
        },
        OrbitParameters: {
          $ref: `#${path}OrbitParametersType`
        },
        GranuleSpatialRepresentation: {
          $ref: `#${path}GranuleSpatialRepresentationEnum`
        }
      },
    ...
    GeometryType: {
      ...
      properties: {
        ...
        BoundingRectangles: {
          type: 'array',
          items: {
            $ref: `#${path}BoundingRectangleType`
          },
          minItems: 1
        },
        GPolygons: {
    ...
    PointType: {
      ...
      properties: {
        Longitude: {
          $ref: `#${path}LongitudeType`
        },
        Latitude: {
          $ref: `#${path}LatitudeType`
        }
      },
    ...
    GPolygonType: {
      ...
      properties: {
        Boundary: {
          $ref: `#${path}BoundaryType`
        },
        ExclusiveZone: {
          $ref: `#${path}ExclusiveZoneType`
        }
      },
      required: ['Boundary']
    },
    ...
    TilingIdentificationSystemType: {
      ...
      properties: {
        TilingIdentificationSystemName: {
          $ref: `#${path}TilingIdentificationSystemNameEnum`
        },
        Coordinate1: {
          $ref: `#${path}TilingCoordinateType`
        },
        Coordinate2: {
          $ref: `#${path}TilingCoordinateType`
        }
    ...
    TilingIdentificationSystemNameEnum: {
      type: 'string',
      enum: ['CALIPSO', 'MISR', 'MODIS Tile EASE', 'MODIS Tile SIN', 'WELD Alaska Tile', 'WELD CONUS Tile', 'WRS-1', 'WRS-2', 'Military Grid Reference System']
    },
    SpatialInformationType: {
      ...
      properties: {
        VerticalCoordinateSystem: {
          $ref: `#${path}VerticalCoordinateSystemType`
        },
        SpatialCoverageType: {
    ...
    VerticalCoordinateSystemType: {
      ...
      properties: {
        AltitudeSystemDefinition: {
          $ref: `#${path}AltitudeSystemDefinitionType`
        },
        DepthSystemDefinition: {
          $ref: `#${path}DepthSystemDefinitionType`
        }
      }
    },
      ...
      anyOf: [{
        ...
        properties: {
          ...
          Media: {
            ...
            type: 'array',
            items: {
              $ref: `#${path}DistributionMediaType`
            },
            minItems: 1
          },
          AverageFileSize: {
    ...
    ArchiveAndDistributionInformationType: {
      ...
      properties: {
        FileArchiveInformation: {
          ...
          type: 'array',
          items: {
            $ref: `#${path}FileArchiveInformationType`
          },
          minItems: 1
        },
        FileDistributionInformation: {
          ...
          type: 'array',
          items: {
            $ref: `#${path}FileDistributionInformationType`
          },
          minItems: 1
        }
      },
